var EpisodeBackstage = React.createClass({
  ...
  sendUpdate:function(){
    ...
    //   activeConnectionIds.push(self.streams[i].connection.id);
    // };



    // var api = "/api/episodes/"+EPISODE_ID+"/update";
    // var data = {
    ...
    // $.post(api, data).complete(function( data ) {
    //   // console.log( "Api [update episode] Response: ", data );
    // });
  },
